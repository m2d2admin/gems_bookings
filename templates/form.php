<?php
    $eventkey = get_query_var( 'event', '64cbb86c14fb2' );
...
<script>
    ...
    jQuery(document).ready(function($) {
        ...
        $(document).on('click', '.hotel-labels input', function(e) {
            ...
            // $('.hotel-labels input').prop('checked', false).removeAttr('checked');            
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="card-body-hotel-room-qty-sel rooms-item">
                                                <div class="input-group plus-minus-input">
                                                    ...
                                                    <input type="hidden" name="rooms[${item.id}]" value="0">
                                                    <input placeholder="Hotelroom" class="input-group-field rooms_count number" type="number" name="hotel_room_count[]" value="0" required data-room_name="${item.name}" data-quantity="${item.quantity}" data-price="${item.price}">
                                                    <div class="input-group-button">												
                                                        <span class="button hollow circle value-button-room plus_room" data-quantity="plus" data-field="quantity">
                                                            <i class="fa fa-plus" aria-hidden="true"></i>
                                                        </span>
            ...
            success: function(response) {
                ...
                if (response.type === 'success') {
                    ...
                    $.each(flightsData, function(index, j) {
                        ...
                        <div class="col vervoer-radio-btn-group">
                            <label class="vervoer-radio-btn-label">
                                <input type="radio" name="flight_plan_id" value="${index}" data-fp_id="${j.fp_id}" data-planName="${j.plan_name}" data-price="${j.price}" data-standard_luggage_weight="${j.standard_luggage_weight}" data-customer_pays_for_hand_luggage="${j.customer_pays_for_hand_luggage}" data-hand_luggage_price="${j.hand_luggage_price}" data-customer_book_extra_luggage="${j.customer_book_extra_luggage}" data-extra_luggage_weight="${j.extra_luggage_weight}" data-extra_luggage_price="${j.extra_luggage_price}" class="card-input-element" />
                                <div class="card card-default card-input">
                                    <div class="card-header">
                                        <div class="card-title">${j.plan_name}</div>
                                        <div class="card-title-icon">
                                ...
                                <form name="flights_form" id="flights_form">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col vervoer-radio-btn-group">
                                            ...
                                            <label class="vervoer-radio-btn-label">
                                                <input type="radio" name="flight_plan_id" value="0" class="card-input-element" />
